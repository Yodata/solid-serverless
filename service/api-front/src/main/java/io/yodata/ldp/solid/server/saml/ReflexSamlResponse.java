package io.yodata.ldp.solid.server.saml;
 ...
 */
public class ReflexSamlResponse {
    /**
     * Private property to construct a logger for this class.
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(com.onelogin.saml2.authn.SamlResponse.class);
     ...
     */
    public ReflexSamlResponse(Saml2Settings settings, String currentUrl, String body) throws XPathExpressionException, ParserConfigurationException, SAXException, IOException, SettingsException, ValidationError {
        this.settings = settings;
        this.currentUrl = currentUrl;
        loadXmlFromBase64(URLDecoder.decode(body.replaceFirst("SAMLResponse=", "")));
    }

    /**
     * Load a XML base64encoded SAMLResponse
     *
     * @param responseStr Saml2Settings object. Setting data
     * @throws ParserConfigurationException
     * @throws SettingsException
     * @throws IOException
     * @throws SAXException
     ...
     *
     * @param responseInResponseTo The InResponseTo value of the SAML Response
     * @throws XPathExpressionException
     * @throws ValidationError
     */
     ...
     * @throws IllegalArgumentException if the response not contain status or if Unexpected XPath error
     * @throws ValidationError
     */
     ...
     *
     * @param signedElements the elements to be validated
     ...
     *
     * @param url the url to set as currentUrl
     */
     ...
     *
     * @param assertionXpath Xpath Expression
     ...
     *
     * @param nameQuery Xpath Expression
